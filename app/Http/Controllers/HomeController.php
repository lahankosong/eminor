...
class HomeController extends Controller
{
    ...
    public function sitemap()
    {
        ...
        foreach (['tools.index', 'tools.potong-lagu', 'tools.hapus-vokal', 'tools.cover-art', 'tools.kartu-rilis', 'tools.countdown', 'tools.edit-metadata', 'tools.chord-builder', 'tools.bpm-kalkulator', 'tools.kalkulator-royalti', 'tools.rate-card', 'tools.transpose-kunci', 'tools.epk', 'gig.board'] as $toolRoute) {
            try {
                $xml .= '  <url>' . "\n";

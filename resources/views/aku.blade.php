...
(function(){
  ...
  // inject progress bar tipis di atas halaman
  ...
  bar = setTimeout(function(){
    ...
    // ubah konten modal menjadi pesan konversi
    var mh = document.querySelector('#mbg .mh');
    var ms = document.querySelector('#mbg .ms');

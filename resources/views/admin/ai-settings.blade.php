        ...
        <form method="POST" action="{{ route('admin.ai-agent.provider.store') }}">
            ...
            <div class="fg">
                ...
                <select class="fi" id="imgPresetSelect" onchange="applyImgPreset(this.value)">
                    ...
                    <option value="imagen">Google Gemini Imagen (butuh key)</option>
...
var IMG_PRESETS = {
    ...
    'imagen':             {name:'Gemini Imagen',      model:'imagen-3.0-generate-002', format:'imagen', base_url:'https://generativelanguage.googleapis.com/v1beta'},

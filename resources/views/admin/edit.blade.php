...
<style>
    ...
    .detector-title {
        font-size: 11px; color: #4a6fa5; letter-spacing: 0.1em;
    ...
    .btn-upload {
        ...
        border: 1px solid #2a2a5a; color: #60a5fa; background: transparent;
        cursor: pointer; transition: 0.15s; white-space: nowrap;
    }
    .btn-upload:hover { background: #1a1a3a; }
    .file-name { font-size: 11px; color: #444; }
    .progress-bar {
    ...
    .result-label { font-size: 10px; color: #555; text-transform: uppercase; letter-spacing: 0.1em; }
    .result-value { font-size: 18px; font-weight: 500; color: #60a5fa; }
    .btn-apply {
        padding: 6px 16px; border-radius: 6px; font-size: 12px;
        border: 1px solid #2a5a2a; color: #4ade80; background: transparent;
        cursor: pointer; transition: 0.15s;
    }
    .btn-apply:hover { background: #0a2a0a; }
</style>
@endpush
            ...
            <div class="form-group">
                ...
                <div class="form-group full">
                    ...
                    <div style="display:flex;align-items:center;gap:12px;">
                        ...
                        @else
                        <span style="font-size:12px;color:#333;">Belum ada file audio</span>
                        @endif

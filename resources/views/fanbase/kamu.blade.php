...
<div class="tuner-card">
    ...
    <div class="tuner-headstock-wrap">
        <div class="tuner-hs">
            ...
            <button class="tuner-peg" style="left:-5%;top:41.5%"  data-freq="110.00" data-label="A" id="pegA"  onclick="tunerPickPeg(this)"><span class="pg-txt">A</span></button>
            ...
            <button class="tuner-peg" style="left:105%;top:41.5%" data-freq="246.94" data-label="B" id="pegB"  onclick="tunerPickPeg(this)"><span class="pg-txt">B</span></button>
